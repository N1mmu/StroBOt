...
class action(commands.Cog):
  ...
  @commands.command()
  async def cuddle(self,ctx,arg1):
  ...
  @commands.command()
  async def makeout(self,ctx,arg1):
  ...
  @commands.command()
  async def shoulder(self,ctx,arg1):
...
#async def secret(ctx,arg1):
  ...
  @commands.command()
  async def holdhands(self,ctx,arg1):
  ...
  @commands.command()
  async def buttrub(self,ctx,arg1):
